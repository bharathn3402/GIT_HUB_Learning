...
from Frimware_Update import FirmwareUpdateWindow
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.Frimware_updateWindow = FirmwareUpdateWindow(self)
    ...
    def restart_application(self):
        ...
        self.HandshakeWindow.handshakeStatusLabel.clear()
        self.HandshakeWindow.uploadInProgressLabel.setVisible(False)
